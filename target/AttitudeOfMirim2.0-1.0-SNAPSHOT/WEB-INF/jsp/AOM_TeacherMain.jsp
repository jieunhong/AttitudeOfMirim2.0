...
<body>
  ...
  <div class="container">
	...
	<br>
	  	...
	  	<tr>
			  	<td><img src="../../../resources/static/img/1.jpg" width=150 height=150 class="hand"
                         onclick="location.href='AOM_InsertScoreForm.jsp'"></td>
			  	<td><img src="../../../resources/static/img/2.jpg" width=150 height=150 class="hand" onclick="location.href='AOM_GradeScoreForm.jsp'"></td>
			  	<td><img src="../../../resources/static/img/3.jpg" width=150 height=150 class="hand" onclick="location.href='AOM_ClassScoreForm.jsp'"></td>
			  	<td><img src="../../../resources/static/img/4.jpg" width=150 height=150 class="hand" onclick="location.href='AOM_StudentScoreForm.jsp'"></td>
	  	</tr>
		<tr>
